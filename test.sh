...
# dump to file
outfile="$1.gif"
#vlc -I dummy --reset-plugins-cache --codec anigif -vvv "$input" --sout "#transcode{width=320,venc=anigif,acodec=none}:standard{mux=raw,dst=${outfile},access=file}" vlc://quit
